...
<img src="https://latex.codecogs.com/svg.image?\bg{white}Q=\frac{1}{2m}\sum_{i,j}^{}\left(A_{ij}-\frac{d_id_j}{2m}\right)\delta(C_i,C_j)">
...
<img src="https://latex.codecogs.com/svg.image?\bg{white}f_a(d)=k_a\times&space;log(d);f_r(d)=\frac{k_r}{d^2}">
...
<img src="https://latex.codecogs.com/svg.image?\bg{white}E=\sum_{i=1}^{n-1}\sum_{j=i&plus;1}^{n}\frac{1}{2}(|p_i-p_j|-l_{ij})^2">
...
<img src="https://latex.codecogs.com/svg.image?\bg{white}l_{ij}=L\times&space;d_{ij}">
...
<img src="https://latex.codecogs.com/svg.image?\bg{white}L=\frac{Lo}{max_{i<j}(d_{ij})}">

Сила пружины, соединяющей pi и pj, обозначается параметром kij:

<img src="https://latex.codecogs.com/svg.image?\bg{white}k_{ij}=K/d_{ij}^2">
...
<img src="https://latex.codecogs.com/svg.image?\bg{white}\Delta&space;m=\sqrt{\left(\frac{\partial&space;E}{\partial&space;x_m}\right)^2&plus;\left(\frac{\partial&space;E}{\partial&space;y_m}\right)^2}">
...
<img src="https://latex.codecogs.com/svg.image?\bg{white}f_a(d)=\frac{d^2}{k};f_r(d)=-\frac{k^2}{d}">
